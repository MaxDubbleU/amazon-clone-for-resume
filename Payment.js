...
function Payment() {
    ...
    useEffect(() => {
        //generate the special stripe secret which lets us charge a customer
    ...
    const handleSubmit = async event => {
        ...
        const payload = await stripe.confirmCardPayment(clientSecret, {payment_method: {
          ...
          // paymentIntent = payment comfiration
    ...
    const handleChange = event => {
        // listen for changes in the CardElement and display any errors as the card details are typed
