...
function Home() {
   ...
   alt="" />      
        ...
        <div className="home_row">
            <Product
            id="23445930" title="Amazon Echo (3rd generation) | Smart Speaker with Alexa, Charcoal Fabric" price={98.99} rating={5}
            image="https://media.very.co.uk/i/very/P6LTG_SQ1_0000000071_CHARCOAL_SLf?$300x400_retinamobilex2$"
            />
            <Product
            id="4903850" title="Samsung CHG90 49' Curved LED Gaming Monitor" price={199.99} rating={3}
            ...
            />
            <Product
            id="3254354345" title="New Apple iPad Pro (12.9-inch, Wi-Fi, 128GB) - Silver (4th Generation)" price={598.99} rating={4}
        ...
        <div className="home_row">
            <Product
            id="90829332" title="Samsung - G97T Series LC49G97TSSNXDC 49' Class 1000R Curved Gaming Monitor - Black" price={1,479} rating={4}
            image="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6425/6425569_sd.jpg;maxHeight=640;maxWidth=550"
            />
        </div>
